...
from ._multiarray_umath import __replace_impl
...
__all__ = [
    ...
    'conjugate', 'copysign', 'cos', 'cosh', 'count', 'bitwise_count', 'deg2rad', 'degrees',
    'divide', 'divmod', 'e', 'equal', 'euler_gamma', 'exp', 'exp2', 'expm1', 'fabs', 'find',
    'floor', 'floor_divide', 'float_power', 'fmax', 'fmin', 'fmod', 'frexp',
    'frompyfunc', 'gcd', 'greater', 'greater_equal', 'heaviside',
    'hypot', 'invert', 'isalpha', 'isfinite', 'isinf', 'isnan', 'isnat', 'lcm', 'ldexp',
    ...
    'reciprocal', 'remainder', 'replace', 'rfind', 'right_shift', 'rint', 'sign',
